...
{
    /// <inheritdoc />
    public partial class initmeg : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryIngredients", x => x.CategoryIngredientId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryMeals", x => x.CategoryMealId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategorySizeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameEnglish = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameArabic = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySizes", x => x.CategorySizeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sizes_CategorySizes_CategorySizeId",
                        column: x => x.CategorySizeId,
                        principalTable: "CategorySizes",
                        principalColumn: "CategorySizeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MealSizeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MealId = table.Column<int>(type: "int", nullable: false),
                    SizeId = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealSizes", x => x.MealSizeId);
                    table.ForeignKey(
